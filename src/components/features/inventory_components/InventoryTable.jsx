...
const InventoryTable = ({data, role, onIncrease, onDecrease, onEdit}) => {
    return (
      ...
      <Table>
        ...
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="py-3 px-4 flex justify-center gap-1.5">Actions</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {data.map((item) => (
